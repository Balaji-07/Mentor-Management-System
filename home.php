<?php
   ...
   $email = $_SESSION['unameMMS'];
   $sql = "SELECT  uname FROM reg WHERE email='$email'";
   $result = $db->query($sql);
...
<html> 
    <head>
        <title>Home</title>
        <link rel="icon" type="image/x-icon" href="https://cdn4.iconfinder.com/data/icons/sapphire-storm-1/32/color-web3-14-512.png">
    ...
    <div class="popup-content">
        <h5><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg> Information</h5>
      <p>By Account Button in the nav bar you can edit your details</p>
    </div>
  </div>
    <div class="welcome">
        <center><h1 class="display-6">Welcome <?php echo $sessHolder; ?>...</h1></center>
    </div>

        <div class="img">
            <img src="https://cdn-icons-png.flaticon.com/128/609/609001.png">
            <img class="two" src="https://media.giphy.com/media/n8DNCT49yl1keRq8p5/giphy.gif">
        </div>
        <div class="text">
            <center><p>This is the sample Login/SignUp page using HTML, CSS, JS, Bootstrap.</p></center>
        </div>
        <div class="footer">
        ...
        <script src="timeout.js?v=<?php echo time(); ?>"></script>
        <script>
